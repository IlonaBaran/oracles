    ...
    data() {
        return {
            ...
            chartOptions4: ({
                ...
                title: {text: 'En attente de données'},
                accessibility: {description: 'En attente de données', keyboardNavigation: {seriesNavigation: { mode: 'serialize' }}},
                lang: {accessibility: { axis: { xAxisDescriptionPlural: 'En attente de données' }}},
                yAxis: {title: { text: 'En attente de données', x: 0 }, labels: { format: '{value:,.0f} MAMSL' }, gridLineDashStyle: 'Dash'},
                xAxis: [],
